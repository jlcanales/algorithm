...
public class RevQuickSort<T extends Comparable<T>> extends Function3<List<T>, Integer, Integer, Long> {
	...
	private static Logger log = LoggerFactory.getLogger(RevQuickSort.class);
	...
	public RevQuickSort(Function2<Integer, Integer, Integer> aiPivotSelector) {
		super();
